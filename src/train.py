...
callback =[
    ...
    ModelCheckpoint(filepath="/mnt/c/Users/jjvas/OneDrive/Desktop/DL-Project/models/best_model.keras", monitor="val_loss", save_best_only =True),
...
#plt.plot(history.history['val_accuracy'], label='Validcation Accuracy')
plt.xlabel('Epochs')
plt.ylabel('Accuracy')
plt.legend()
